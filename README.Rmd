...
> **Status: v0.1.2** — Stable for production use and compatible with `shinyapps.io`. This is an early release of `fastgeojson`, so we are actively looking for edge cases; bug reports and feature requests are very welcome.
