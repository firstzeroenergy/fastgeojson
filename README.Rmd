...
Implemented in Rust via the **extendr** framework, it uses parallel processing and low-level optimizations to deliver **2.3–15× speedups** over existing R solutions on large datasets.
