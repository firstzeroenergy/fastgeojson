...
> **Status: v0.2.2** — Adds dataframe = ("rows", columns"), na = ("null, "string", and null = ("null", "list") arguments to as_json().
...
Progress continues on replicating the full behavior or jsonlite::toJSON(), with the following input arguments currently available:
-auto_box = (TRUE, FALSE)
...
`fastgeojson` v0.2.2 supports serialization for a wide range of R data types:
