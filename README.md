...
processing and low-level optimizations to deliver **1.5–6× speedups**
...
> **Status: v0.1.0 (Beta)** — This release demonstrates the performance
> potential of Rust-based serialization in R. While thoroughly tested on
> common use cases, feedback on edge cases is highly encouraged!
...
``` r
# Preferred: pre-compiled binaries via r-universe (no Rust required)
install.packages("fastgeojson", repos = "https://firstzeroenergy.r-universe.dev")

# Development version from GitHub (requires Rust toolchain)
# remotes::install_github("firstzeroenergy/fastgeojson")
```
